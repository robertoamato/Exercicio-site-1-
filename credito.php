...
<body>
	...
	<div class="conteudo">
		...
		if ($renda>=2000) {
			echo "Parabens seu credito esta <strong>Aprovado!</strong>";
			
		}elseif ($renda<2000) {
			echo "Infelizmente neste momento nao poderemos lhe conceder o credito, por favor clique em voltar para acessar a pagina principal";
